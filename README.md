...
**Minimum Bar:** All three models can be instantiated. Each model possesses the correct attributes and functional getter/setter methods. Models relate to one another through relational methods.
